...
INSERT INTO Subcategorias (Nombre, CategoriaId, Activo)
...
-- Procesadores
INSERT INTO Productos (Nombre, Descripcion, Precio, Stock, MarcaId, SubcategoriaId, Activo, Novedad)
...
INSERT INTO EstadosPedido (NombreEstado, Activo)
VALUES ('Pendiente', 1),
       ('Confirmado', 1),
       ('En Proceso', 1),
       ('Enviado', 1),
...
INSERT INTO MetodosPago (NombreMetodo, Activo)
VALUES (N'Tarjeta de Crédito', 1),
       (N'Tarjeta de Débito', 1),
       ('PayPal', 1);

-- Insertar tipos de movimiento para Kardex
INSERT INTO TipoMovimientoKardex (Tipo, Entrada, Activo)
VALUES ('Entrada', 1, 1),
       ('Salida', 0, 1),
       (N'Devolución', 0, 1),
       (N'Dañado', 0, 1),
